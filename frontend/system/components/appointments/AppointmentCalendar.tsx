...
import calendarHoursCreator from "@/system/modules/CalendarHoursCreator";
...
function AppointmentCalendar(props: CalendarProps) {
    ...
    const calendarHours = calendarHoursCreator(props.data);
        ...
        <div className="w-full flex h-full border border-slate-200 bg-white rounded-lg p-6 flex-col gap-6">
            <div className="flex lg:flex-row flex-col gap-6 lg:items-center items-start justify-between sm:w-auto w-full">
                <div className="flex flex-row gap-3 items-center justify-center">
                    <PageNavigator onPreviousClick={() => setWeek(1)} onNextClick={() => setWeek(2)} labelText="Semana actual" currentPage={week} finalPage={numberOfWeeks} labelStyles="text-2xl font-medium text-slate-900 tracking-tight" />
            ...
            <div className="calendar flex w-full">
