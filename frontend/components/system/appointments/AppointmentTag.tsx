...
function AppointmentTag(props: TagProps) {
    return (
        <div className={`flex flex-row gap-1 items-center justify-center border px-2.5 py-1 h-auto rounded-full ${tagStyles[props.type].textColor} ${tagStyles[props.type].bgColor} ${tagStyles[props.type].borderColor} `}>
