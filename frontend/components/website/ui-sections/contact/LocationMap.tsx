...
function LocationMap() {
    ...
    const isMapVisible = isVisible(ref1);
    ...
    return (
        <section className="relative w-full lg:pt-10 lg:pb-40 md:pt-10 md:pb-30 py-12 lg:px-20 sm:px-14 px-8 flex flex-col lg:gap-20 sm:gap-15 gap-10 items-center justify-center">
            ...
            {/* Content */}
            <div ref={ref1} className={`${isContentVisible ? 'top-0 opacity-100' : 'top-30 opacity-0'} relative flex flex-col gap-5 items-center justify-center transition-all duration-1000 ease-out`}>
            ...
            className="relative w-full h-128 rounded-2xl shadow-[0_3px_10px_rgb(0,0,0,0.2)]"></iframe>
        </section>
    )
}
